...
r90 = createTechnique('rotate', {'angle': 90})
r180 = createTechnique('rotate', {'angle': 180})
r270 = createTechnique('rotate', {'angle': 270})
...
augmentor.addTransformer(transformer(r90))
augmentor.addTransformer(transformer(r180))
augmentor.addTransformer(transformer(r270))
